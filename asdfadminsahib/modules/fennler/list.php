<?=$arr = $crud->show_list($_GET['module']);?>
...
HTML;
            ...
            <button class="btn btn-warning logicalDeleteRows" style="outline: none; float: right;" delete_type="fenn" module="<?= $_GET['module'];?>">Delete selected</button>
        </div>
    </div>
</div>
