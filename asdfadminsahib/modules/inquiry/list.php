...
$arr = $crud->list_for_categories($_GET['module'], 'clients', "t1.id, CONCAT(t2.name, ' ', t2.surname) as `user`, t1.islike, t1.point, t1.message", 't1.user_id=t2.id', " ORDER By `id` DESC LIMIT {$first}, {$last}");
